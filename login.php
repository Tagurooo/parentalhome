    ...
    <section style="padding: 15px;">
        <div class="login-logo">
            <div class="text-center">
                <img src="img/rasp.png" alt="Pi-hole logo" class="loginpage-logo">
            </div>
            <div class="panel-title text-center"><span class="logo-lg" style="font-size: 25px;">Parental<b>Home</b></span></div>
        </div>
        <!-- /.login-logo -->
                ...
                <form action="" id="loginform" method="post">
                    <div class="form-group login-options has-feedback<?php if ($wrongpassword) { ?> has-error<?php } ?>">
                        ...
                        <div>
                            ...
                            <label for="logincookie">Remember me</label>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box box-<?php if (!$wrongpassword) { ?>info collapsed-box<?php } else { ?>danger<?php }?>">
                            ...
                            <div class="box-body">
                                <p>After installing Parental home for the first time, a password is generated and displayed
